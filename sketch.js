...
function draw(){
   ...
   // console.log(r6);
    ...
    healthSprite.x = pos.x +170;
    healthSprite.y = pos.y-350;

    infoSprite.x = pos.x+1245;
    infoSprite.y = pos.y+-350;
   // infoSprite.scale = c;

    gunSprite.x = pos.x+1170;
    gunSprite.y = pos.y-355;
  ...
  //// code for giving the up  down left right velocities 
    ...
    //// code for defining the directions 
    ...
    noStroke();
    fill('red');
    rect(pos.x-665,pos.y-713,288,26);
    pop();
    ...
    noStroke();
    fill('blue');
    rect(pos.x-665,pos.y-651,fuel,26);
    pop();

    //console.log(bulletGroup1);

    //console.log(b3.body.position);
...
/*
    ...
    w67.display();
*/
 //  Matter.Body.setPosition(w67.body,{x:a,y:b});
  // Matter.Body.setAngle(w67.body,c);
